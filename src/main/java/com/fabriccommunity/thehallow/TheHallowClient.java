...
import com.fabriccommunity.thehallow.client.HallowClientNetworking;
import com.fabriccommunity.thehallow.client.HallowColors;
...
import com.fabriccommunity.thehallow.client.render.RestlessCactusEntityRenderer;
...
public class TheHallowClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		EntityRendererRegistry.INSTANCE.register(RestlessCactusEntity.class, (dispatcher, context) -> new RestlessCactusEntityRenderer(dispatcher));
