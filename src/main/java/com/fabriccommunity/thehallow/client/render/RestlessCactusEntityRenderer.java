...
public class RestlessCactusEntityRenderer extends MobEntityRenderer<RestlessCactusEntity, EntityModel<RestlessCactusEntity>> {
	private static final Identifier SKIN = new Identifier(TheHallow.MOD_ID, "textures/entity/pumpcown.png");
	
	public RestlessCactusEntityRenderer(EntityRenderDispatcher dispatcher) {
	...
	public void render(RestlessCactusEntity entity, double x, double y, double z, float float_1, float float_2) {
		...
		BlockState state = HallowBlocks.RESTLESS_CACTUS.getDefaultState();
