...
import com.fabriccommunity.thehallow.world.layer.HallowBiomeLayers;
...
public class HallowBiomeSource extends BiomeSource {
	public final Biome[] allowedBiomes;
	
	public final BiomeLayerSampler biomeLayer, noiseLayer;
	
	public HallowBiomeSource(long seed) {
		allowedBiomes = new Biome[]{
			HallowBiomes.HALLOWED_FOREST,
			HallowBiomes.HALLOWED_FOREST_HILLS,
			HallowBiomes.HALLOWED_LOWLANDS,
			HallowBiomes.HALLOWED_LOWLANDS_BARROWS,
			HallowBiomes.HALLOWED_LOWLANDS_PUMPKINS,
			HallowBiomes.GHASTLY_DESERT,
			HallowBiomes.HALLOWED_RIVER,
			HallowBiomes.HALLOWED_SEA,
			HallowBiomes.HALLOWED_SHORE,
			HallowBiomes.HALLOWED_SWAMP,
			HallowBiomes.HAUNTED_UPLANDS,
			HallowBiomes.HAUNTED_MOOR
		};
		
		BiomeLayerSampler[] samplers = HallowBiomeLayers.build(seed);
