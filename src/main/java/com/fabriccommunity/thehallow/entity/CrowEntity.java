...
public class CrowEntity extends AnimalEntity implements Bird {
	...
	protected void initGoals() {
		...
		this.goalSelector.add(2, new EatBreadcrumbsGoal(HallowBlocks.BREAD_CRUMBS, this, 1.25D, 40, 80));
		this.goalSelector.add(2, new TemptBirdGoal(this, 1.25D, false, Ingredient.ofItems(HallowBlocks.BREAD_CRUMBS)));
	...
	public SoundEvent getAmbientSound() {
		return HallowSounds.CROW_AMBIENT;
	}
