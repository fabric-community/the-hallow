...
public class HallowedTreasureChestEntity extends Entity {
	public static final Identifier ENTITY_ID = new Identifier(TheHallow.MOD_ID, "spooky_treasure_chest");
