...
import com.fabriccommunity.thehallow.command.SpookyCommand;
...
public class HallowCommands {
	private HallowCommands() {
		// NO-OP
	}
	
	public static void init() {
		CommandRegistry.INSTANCE.register(false, HallowCommands::register);
	}
