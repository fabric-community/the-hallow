...
public class HallowedBiomes {
	// Hallowed Forest
	public static final HallowedBaseBiome SPOOKY_FOREST = register("hallowed_forest", new HallowedForestBiome(0.15f, 0.18f));
	public static final HallowedBaseBiome SPOOKY_FOREST_HILLS = register("hallowed_forest_hills", new HallowedForestBiome(0.25f, 0.2f));
	
	// Hallowed Lowlands
	public static final HallowedBaseBiome SPOOKY_LOWLANDS = register("hallowed_lowlands", new HallowedLowlandsBiome());
	public static final HallowedBaseBiome SPOOKY_LOWLANDS_PUMPKINS = register("pumpkin_patch", new PumpkinPatchBiome());
	public static final HallowedBaseBiome SPOOKY_LOWLANDS_BARROWS = register("hallowed_lowlands_barrows", new LowlandBarrowsBiome());
	
	//Ghastly Desert
	public static final HallowedBaseBiome GHASTLY_DESERT = register("ghastly_desert", new GhastlyDesert());
	
	// Hallowed River
	public static final HallowedBaseBiome SPOOKY_RIVER = register("hallowed_river", new HallowedRiverBiome());
	
	// Hallowed Sea
	public static final HallowedBaseBiome SPOOKY_SEA = register("hallowed_sea", new HallowedSeaBiome());
	public static final HallowedBaseBiome SPOOKY_SHORE = register("hallowed_shore", new HallowedShoreBiome());
	
	// Hallowed Swamp
	public static final HallowedBaseBiome SPOOKY_SWAMP = register("hallowed_swamp", new HallowedSwampBiome());
	...
	public static void init() {
		...
		HallowedBaseBiome.BIOMES.forEach(biome -> OverworldBiomes.setRiverBiome(biome, SPOOKY_RIVER));
	}
