...
public class HallowedEntities {
	...
	public static final EntityType<HallowedTreasureChestEntity> SPOOKY_TREASURE_CHEST = register("hallowed_treasure_chest",
	...
	public static final EntityType<HallowedCactusEntity> SPOOKY_CACTUS = register("hallowed_cactus", FabricEntityTypeBuilder.create(EntityCategory.MISC, HallowedCactusEntity::new).size(EntityDimensions.changing(0.9F, 1.0F)).build());
