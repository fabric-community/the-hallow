...
public class HallowedBlocks {
	...
	public static final Block SPOOKY_CACTUS = register("hallowed_cactus", new HallowedCactusBlock(FabricBlockSettings.copy(Blocks.CACTUS).materialColor(MaterialColor.BROWN).build()), new Item.Settings().group(TheHallow.GROUP));
