...
public class BloodFluid extends BaseFluid {
	...
	public Fluid getFlowing() {
		return HallowFluids.FLOWING_BLOOD;
	}
	
	@Override
	public Fluid getStill() {
		return HallowFluids.BLOOD;
	}
	...
	public Item getBucketItem() {
		return HallowItems.BLOOD_BUCKET;
	}
	...
	public boolean method_15777(FluidState fluidState, BlockView blockView, BlockPos blockPos, Fluid fluid, Direction direction) {
		return direction == Direction.DOWN && !fluid.matches(HallowFluidTags.BLOOD);
	}
	...
	public BlockState toBlockState(FluidState fluidState) {
		return HallowBlocks.BLOOD_BLOCK.getDefaultState().with(FluidBlock.LEVEL, method_15741(fluidState));
	}
