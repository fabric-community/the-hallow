...
public class WitchWaterFluid extends BaseFluid {
	...
	public Fluid getFlowing() {
		return HallowFluids.FLOWING_WITCH_WATER;
	}
	...
	public Item getBucketItem() {
		return HallowItems.WITCH_WATER_BUCKET;
	}
	...
	public boolean method_15777(FluidState fluidState, BlockView blockView, BlockPos blockPos, Fluid fluid, Direction direction) {
		return direction == Direction.DOWN && !fluid.matches(HallowFluidTags.WITCH_WATER);
	}
	...
	public BlockState toBlockState(FluidState fluidState) {
		return HallowBlocks.WITCH_WATER_BLOCK.getDefaultState().with(FluidBlock.LEVEL, method_15741(fluidState));
	}
