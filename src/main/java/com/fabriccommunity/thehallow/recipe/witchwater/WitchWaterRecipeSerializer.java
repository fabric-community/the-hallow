package com.fabriccommunity.thehallow.recipe.witchwater;
...
public class WitchWaterRecipeSerializer implements RecipeSerializer<WitchWaterRecipe> {
	private WitchWaterRecipeSerializer() {
		// NO-OP
	}

	public static final WitchWaterRecipeSerializer INSTANCE = new WitchWaterRecipeSerializer();
	public static final Identifier ID = TheHallow.id("witch_water_recipe");
	...
	@Override
	public WitchWaterRecipe read(Identifier id, JsonObject json) {
		Item result;
		int count;
		...
		return new WitchWaterRecipe(ingredients, new ItemStack(result, count), id);
	}
	...
	@Override
	public void write(PacketByteBuf buf, WitchWaterRecipe recipe) {
	...
	@Override
	public WitchWaterRecipe read(Identifier id, PacketByteBuf buf) {
		...
		return new WitchWaterRecipe(ingredients, buf.readItemStack(), id);
	}
}
