...
public class HallowFernBlock extends FernBlock {
	public HallowFernBlock(Settings settings) {
		super(settings);
	}
	
	@Override
	public void grow(World world, Random random, BlockPos pos, BlockState state) {
		TallPlantBlock tallEerie = (TallPlantBlock) HallowBlocks.TALL_EERIE_GRASS;
