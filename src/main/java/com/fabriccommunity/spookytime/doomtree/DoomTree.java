...
public class DoomTree {
	...
	public static final BlockEntityType<AlchemicalBasinBlockEntity> ALCHEMICAL_BASIN =
			Registry.register(Registry.BLOCK_ENTITY, SpookyTime.id("alchemical_basin"), BlockEntityType.Builder.create(AlchemicalBasinBlockEntity::new, DOOM_HEART_BLOCK).build(null));
