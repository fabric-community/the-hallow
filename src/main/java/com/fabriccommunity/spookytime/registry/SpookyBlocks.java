...
public class SpookyBlocks {
    ...
    public static final Block CARVABLE_PUMPKIN = register("carvable_pumpkin", new CarvablePumpkinBlock());
    public static final BlockEntityType<CarvablePumpkinBlockEntity> CARVABLE_PUMPKIN_BLOCK_ENTITY = Registry.<BlockEntityType<CarvablePumpkinBlockEntity>>register(Registry.BLOCK_ENTITY, new Identifier(SpookyTime.MOD_ID, "carvable_pumpkin"), BlockEntityType.Builder.create(CarvablePumpkinBlockEntity::new, CARVABLE_PUMPKIN).build(null));
	...
	public static void init() {
		// All init handled on class load
	}
