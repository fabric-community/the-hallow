...
import com.fabriccommunity.spookytime.item.SpookyItems;
...
public class SpookyBlocks {
    ...
    public static Block CARVABLE_PUMPKIN = register("carvable_pumpkin", new CarvablePumpkinBlock());
    public static BlockEntityType<CarvablePumpkinBlockEntity> CARVABLE_PUMPKIN_BLOCK_ENTITY = Registry.<BlockEntityType<CarvablePumpkinBlockEntity>>register(Registry.BLOCK_ENTITY, new Identifier(SpookyTime.MOD_ID, "carvable_pumpkin"), BlockEntityType.Builder.create(CarvablePumpkinBlockEntity::new, CARVABLE_PUMPKIN).build(null));
