...
public class SpookyBlocks {
	...
	public static final Block TAINTED_SAND = register("tainted_sand", new TaintedSandBlock(FabricBlockSettings.copy(Blocks.SAND).materialColor(MaterialColor.PURPLE).build()));
