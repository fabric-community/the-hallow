...
public class SpookyOreFeatureConfig implements FeatureConfig {
	public final BlockState state;
	public final int size;
	
	public SpookyOreFeatureConfig(BlockState blockState, int size) {
		this.state = blockState;
		this.size = size;
	}
	
	public static SpookyOreFeatureConfig deserialize(Dynamic<?> dynamic) {
		...
		return new SpookyOreFeatureConfig(blockState_1, int_1);
	}
