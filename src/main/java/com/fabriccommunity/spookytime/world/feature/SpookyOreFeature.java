...
public class SpookyOreFeature extends Feature<SpookyOreFeatureConfig> {
    public SpookyOreFeature(Function<Dynamic<?>, ? extends SpookyOreFeatureConfig> function_1) {
        super(function_1);
    }
