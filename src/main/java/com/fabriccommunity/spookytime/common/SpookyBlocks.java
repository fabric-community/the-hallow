...
public class SpookyBlocks {
	...
	public static void init() {
        ...
        Registry.<BlockEntityType<CarvablePumpkinBlockEntity>>register(Registry.BLOCK_ENTITY, new Identifier(SpookyTime.MOD_ID, "carvable_pumpkin"), CARVABLE_PUMPKIN_BLOCK_ENTITY);
