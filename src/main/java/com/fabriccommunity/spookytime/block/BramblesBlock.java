...
import com.fabriccommunity.spookytime.util.SpookyDamageSource;

public class BramblesBlock extends PlantBlock {
	public static final DamageSource DAMAGE_SOURCE = new SpookyDamageSource("brambles");
	...
	public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
		if (entity instanceof LivingEntity && entity.getType() != SpookyEntities.CROW && entity.getType() != SpookyEntities.PUMPCOWN) {
	...
	protected boolean canPlantOnTop(BlockState state, BlockView view, BlockPos pos) {
		...
		return block == SpookyBlocks.TAINTED_SAND || super.canPlantOnTop(state, view, pos);
	}
}
